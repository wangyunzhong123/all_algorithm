...
/*
* 最小生成树的prim算法。和Dijkstra相似。性质是集合A中的边总是构成一棵树。这棵树
* 从任意的根节点r开始，一直长大到覆盖V中的所有节点为止。算法的每一步在连接集合A和A之外的节点所有边中选择一条
* 轻量级的边加入A中
* 贪心思想
* */
...
public class MSTPrim {
     ...
     *     edges -- 边
     */
    public MSTPrim(char[] vexs, EData[] edges) {
