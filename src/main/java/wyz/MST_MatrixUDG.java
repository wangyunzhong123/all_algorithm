...
public class MST_MatrixUDG {
     ...
     *     matrix-- 矩阵(数据)
     */
    public MST_MatrixUDG(char[] vexs, int[][] matrix) {
    ...
    public static void main(String[] args) {
        ...
        // 自定义"图"(输入矩阵队列)
        //pG = new MST_MatrixUDG();
        // 采用已有的"图"
        pG = new MST_MatrixUDG(vexs, matrix);
